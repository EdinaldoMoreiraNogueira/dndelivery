...
public class OrderDTO implements Serializable {
	...
	public OrderDTO(Order entidy) {
		...
		id = entidy.getId();
		address = entidy.getAddress();
		latitude = entidy.getLatitude();
		longitude = entidy.getLongitude();
		moment = entidy.getMoment();
		status = entidy.getStatus();
		total = entidy.getTotal();
